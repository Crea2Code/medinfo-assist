...
- 🤖 **Démontre** la puissance éducative de l’IA appliquée à la santé.
...
| 💡 **Conseil santé intelligent** | FastAPI + Groq API | Fonctionnelle | 💬 Génère un vrai conseil |
...
| **Backend** | FastAPI (Python 3.13) | API d’analyse et de conseil IA |
| **IA** | Groq (LLaMA3-70B) | Traitement sémantique des textes médicaux |
| **Design** | TailwindCSS | Design responsive et épuré |
| **Déploiement** | Render + Vercel | Architecture cloud complète |
| **UI/UX** | Lucide Icons, React Markdown | Icônes et texte formaté |
| **Versioning** | Git + GitHub | CI/CD avec Vercel et Render |
...
- 🧾 Affichage Markdown clair et structuré

- ⚙️ Connexion directe Next.js ↔ FastAPI

- 🎬 Animation d’accueil avec son

- ⚕️ Encadré informatif : “Ce texte est une vulgarisation à but éducatif”

## 🌍 Déploiement continu

Ce projet est automatiquement déployé à chaque git push :

### 🩺 Version en ligne :

**Frontend** : **Vercel** : https://medinfo-assist.vercel.app/

**Backend** : **Render** : https://medinfo-assist-backend.onrender.com/

📘**API Docs** : https://medinfo-assist-backend.onrender.com/docs
